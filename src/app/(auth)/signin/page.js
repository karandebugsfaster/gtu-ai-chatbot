        ...
        <div className="card" style={{ padding: '2rem' }}>
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <label style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: 0, cursor: 'pointer' }}>
                <input
                  type="checkbox"
                  style={{ width: '1rem', height: '1rem', margin: 0 }}
                />
                <span style={{ fontSize: '0.875rem', color: '#374151', fontWeight: '400' }}>Remember me</span>
              </label>
              <a href="#" style={{ fontSize: '0.875rem', color: '#4f46e5', fontWeight: '500', textDecoration: 'none' }}>
                Forgot password?
              </a>
            </div>
          ...
          <p style={{ marginTop: '1.5rem', textAlign: 'center', fontSize: '0.875rem', color: '#6b7280' }}>
            ...
            <Link href="/signup" style={{ fontWeight: '600', color: '#4f46e5', textDecoration: 'none' }}>
              Sign Up
            </Link>
          </p>
        </div>
