...
//     const body = await request.json(); // JSON now, not formData

//     const {
//       title, type, branch, semester,
//       subject, academicYear, author,
//       fileUrl, cloudinaryId, fileSize,
//     } = body;
...
//     if (!fileUrl)     return NextResponse.json({ success: false, error: 'File URL is required' }, { status: 400 });
